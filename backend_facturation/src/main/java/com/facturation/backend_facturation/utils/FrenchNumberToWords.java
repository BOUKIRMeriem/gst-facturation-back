package com.facturation.backend_facturation.utils;
...
public class FrenchNumberToWords {
    ...
    public static String convert(double number) {
        ...
        String firstValue = convertInt(Integer.parseInt(parts[0]));
        if (parts.length > 1){
            if (!"0".equalsIgnoreCase(parts[1])) {
                String secondValue = convertInt(Integer.parseInt(parts[1]));
                firstValue = firstValue + " virgule " + secondValue;
            }
        }
        return  firstValue;
    }
